...
import CategoryForm from "../forms/FormAdmin/CategoryForm/CategoryForm.jsx";
...
const CategoryManager = () => {
  ...
  const totalProductItems = categories?.length
  ...
  const showModal = (type, record) => {
    setSelectedRecord(record); // Lưu thông tin thể loại để chỉnh sửa
    setTypeModal(type);
  ...
  return (
    <CRow>
      <CCardHeader className="justifil-conter">
        <strong>Quản lý danh sách thể loại</strong>
      </CCardHeader>
      <CCardBody>
        <div>
          <Button
        ...
        <Modal
          title={
            typeModal === "edit" ? "Chỉnh sửa thể loại" : "Tạo mới thể loại"
          }
