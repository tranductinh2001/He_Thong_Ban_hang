...
const ColorManager = () => {
  ...
  const totalProductItems = colors?.length;
  ...
  const showModal = (type, record) => {
    setSelectedRecord(record); // Lưu thông tin màu sắc để chỉnh sửa
    setTypeModal(type);
  ...
  return (
    <CRow>
      <CCardHeader className="justifil-conter">
        <strong>Quản lý danh sách màu sắc</strong>
      </CCardHeader>
      <CCardBody>
        <div>
          <Button
        ...
        <Modal
          title={
            typeModal === "edit" ? "Chỉnh sửa màu sắc" : "Tạo mới màu sắc"
          }
